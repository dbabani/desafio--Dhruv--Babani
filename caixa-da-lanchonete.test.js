...
describe('CaixaDaLanchonete', () => {
    ...
    const validaTeste = (formaPagamento, resultadoEsperado, pedido) => {
        const resultado = new CaixaDaLanchonete()
            .calcularTotal(pedido, formaPagamento);
    ...
    ])('compra %p em %p deve resultar em %p', (formaPagamento,resultadoEsperado, pedido) =>
        validaTeste(formaPagamento, resultadoEsperado, pedido));
    ...
    ])('compra %p em %p deve resultar em %p', (_, formaPagamento, resultadoEsperado, pedido) =>
        validaTeste(formaPagamento, resultadoEsperado, pedido));
